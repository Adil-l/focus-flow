    ...
    <div className="space-y-6">
      ...
      <div className="space-y-5">
        ...
        <div className="space-y-2.5">
          ...
          <p className="text-[11px] text-white/40 ml-1 mb-2">For Task ETA Mode, adjust your timer settings in the tasks list.</p>
        ...
        <div className="bg-white/[0.04] rounded-xl p-4 border border-white/[0.05]">
          <div className="flex items-center justify-between gap-3">
            <div className="min-w-0">
              <div className="text-[13px] font-bold text-white/80">Custom Timer Font</div>
              <p className="text-[11px] text-white/40 mt-0.5">Customize your timer & clock style in Clock settings.</p>
            </div>
            <button onClick={onNavigateToClock} className="px-3 py-2 rounded-lg bg-primary/10 text-primary text-xs font-black shrink-0">Open</button>
          </div>
        </div>
        ...
        <div className="space-y-3">
          ...
          <p className="text-[11px] text-white/40 ml-1">Each tally represents one complete focus session.</p>

          {/* Static Session Tally */}
          <div>
            <div className="text-[11px] font-bold text-white/60 mb-2">Static · the same icon repeats</div>
            <div className="grid grid-cols-3 gap-2">
          ...
          <div className="mt-4">
            <div className="text-[11px] font-bold text-white/60 mb-2">Dynamic · icons that evolve</div>
            <div className="grid grid-cols-3 gap-2">
